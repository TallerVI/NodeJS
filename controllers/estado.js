...
var updateAll 		= function(request, response){
	serverrequest.load("","/estado", request.body, "6000", "PUT", request,response);
};
var updatePart 		= function(request, response){
	serverrequest.load("","/estado", "", "6000", "PATCH", request,response);
};
var deleteById 		= function(request, response){
	serverrequest.load("","/estado", request.params.estadoid, "6000", "DELETE", request,response);
};
