...
var updateAll 		= function(request, response){
	serverrequest.load("","/funcion", request.body, "6000", "PUT", request,response);
};
var updatePart 		= function(request, response){
	serverrequest.load("","/funcion", "", "6000", "PATCH", request,response);
};
var deleteById 		= function(request, response){
	serverrequest.load("","/funcion", request.params.funcionid, "6000", "DELETE", request,response);
};
