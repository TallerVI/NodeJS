...
var updateAll 		= function(request, response){
	serverrequest.load("","/maquinaestado", request.body, "6000", "PUT", request,response);
};
var updatePart 		= function(request, response){
	serverrequest.load("","/maquinaestado", "", "6000", "PATCH", request,response);
};
var deleteById 		= function(request, response){
	serverrequest.load("","/maquinaestado", request.params.maquinaestadoid, "6000", "DELETE", request,response);
};
