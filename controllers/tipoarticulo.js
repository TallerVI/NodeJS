...
var updateAll 		= function(request, response){
	serverrequest.load("","/tipoarticulo", request.body, "4000", "PUT", request,response);
};
var updatePart 		= function(request, response){
	serverrequest.load("","/tipoarticulo", "", "4000", "PATCH", request,response);
};
var deleteById 		= function(request, response){
	serverrequest.load("","/tipoarticulo", request.params.tipoarticuloid, "4000", "DELETE", request,response);
};
