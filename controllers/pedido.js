...
var updateAll 		= function(request, response){
	serverrequest.load("","/pedido", request.body, "6000", "PUT", request,response);
};
var updatePart 		= function(request, response){
	serverrequest.load("","/pedido", "", "6000", "PATCH", request,response);
};
var deleteById 		= function(request, response){
	serverrequest.load("","/pedido", request.params.pedidoid, "6000", "DELETE", request,response);
};
